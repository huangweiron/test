<?php /*a:1:{s:72:"D:\field\phpstudy_pro\WWW\test\app\index\view\tcontainer\curriculum.html";i:1576824651;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <<</button> <table cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="readclass?classId=<?php echo htmlentities($classId); ?>&&sktimeId=<?php echo htmlentities($vo['Id']); ?>">查看</a>
                </td>
            </tr>
